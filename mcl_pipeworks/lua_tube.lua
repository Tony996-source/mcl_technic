...
local function get_interrupt(pos)
	...
	local function interrupt(time, iid)
		...
		mesecon.queue:add_action(pos, "mcl_pipeworks:lc_tube_interrupt", {luac_id, iid}, time, iid, 1)
	end
	return interrupt
end
...
mesecon.queue:add_function("mcl_pipeworks:lc_tube_interrupt", function (pos, luac_id, iid)
...
local node_box = {
	type = "fixed",
	fixed = {
		mcl_pipeworks.tube_leftstub[1],   -- tube segment against -X face
		mcl_pipeworks.tube_rightstub[1],  -- tube segment against +X face
		mcl_pipeworks.tube_bottomstub[1], -- tube segment against -Y face
		mcl_pipeworks.tube_topstub[1],    -- tube segment against +Y face
		mcl_pipeworks.tube_frontstub[1],  -- tube segment against -Z face
		mcl_pipeworks.tube_backstub[1],   -- tube segment against +Z face
	}
}

local selection_box = {
	type = "fixed",
	fixed = mcl_pipeworks.tube_selectboxes,
}
...
local function go_back(velocity)
	...
	vel.speed = speed
	return mcl_pipeworks.notvel(adjlist, vel)
end

local tiles_base = {
	"mcl_pipeworks_mese_tube_plain_4.png", "mcl_pipeworks_mese_tube_plain_3.png",
	"mcl_pipeworks_mese_tube_plain_2.png", "mcl_pipeworks_mese_tube_plain_1.png",
	"mcl_pipeworks_mese_tube_plain_6.png", "mcl_pipeworks_mese_tube_plain_5.png"}
...
for white  = 0, 1 do
	...
	local node_name = "mcl_pipeworks:lua_tube" ..cid
	local tiles = table.copy(tiles_base)
	if red == 1 then
		tiles[1] = tiles[1].."^(mcl_pipeworks_lua_tube_port_on.png^[transformR90)"
		tiles[2] = tiles[2].."^(mcl_pipeworks_lua_tube_port_on.png^[transformR90)"
		tiles[5] = tiles[5].."^(mcl_pipeworks_lua_tube_port_on.png^[transformR270)"
		tiles[6] = tiles[6].."^(mcl_pipeworks_lua_tube_port_on.png^[transformR90)"
	else
		tiles[1] = tiles[1].."^(mcl_pipeworks_lua_tube_port_off.png^[transformR90)"
		tiles[2] = tiles[2].."^(mcl_pipeworks_lua_tube_port_off.png^[transformR90)"
		tiles[5] = tiles[5].."^(mcl_pipeworks_lua_tube_port_off.png^[transformR270)"
		tiles[6] = tiles[6].."^(mcl_pipeworks_lua_tube_port_off.png^[transformR90)"
	end
	if blue == 1 then
		tiles[1] = tiles[1].."^(mcl_pipeworks_lua_tube_port_on.png^[transformR270)"
		tiles[2] = tiles[2].."^(mcl_pipeworks_lua_tube_port_on.png^[transformR270)"
		tiles[5] = tiles[5].."^(mcl_pipeworks_lua_tube_port_on.png^[transformR90)"
		tiles[6] = tiles[6].."^(mcl_pipeworks_lua_tube_port_on.png^[transformR270)"
	else
		tiles[1] = tiles[1].."^(mcl_pipeworks_lua_tube_port_off.png^[transformR270)"
		tiles[2] = tiles[2].."^(mcl_pipeworks_lua_tube_port_off.png^[transformR270)"
		tiles[5] = tiles[5].."^(mcl_pipeworks_lua_tube_port_off.png^[transformR90)"
		tiles[6] = tiles[6].."^(mcl_pipeworks_lua_tube_port_off.png^[transformR270)"
	end
	if yellow == 1 then
		tiles[3] = tiles[3].."^(mcl_pipeworks_lua_tube_port_on.png^[transformR180)"
		tiles[4] = tiles[4].."^(mcl_pipeworks_lua_tube_port_on.png^[transformR180)"
		tiles[5] = tiles[5].."^(mcl_pipeworks_lua_tube_port_on.png^[transformR180)"
		tiles[6] = tiles[6].."^(mcl_pipeworks_lua_tube_port_on.png^[transformR180)"
	else
		tiles[3] = tiles[3].."^(mcl_pipeworks_lua_tube_port_off.png^[transformR180)"
		tiles[4] = tiles[4].."^(mcl_pipeworks_lua_tube_port_off.png^[transformR180)"
		tiles[5] = tiles[5].."^(mcl_pipeworks_lua_tube_port_off.png^[transformR180)"
		tiles[6] = tiles[6].."^(mcl_pipeworks_lua_tube_port_off.png^[transformR180)"
	end
	if green == 1 then
		tiles[3] = tiles[3].."^mcl_pipeworks_lua_tube_port_on.png"
		tiles[4] = tiles[4].."^mcl_pipeworks_lua_tube_port_on.png"
		tiles[5] = tiles[5].."^mcl_pipeworks_lua_tube_port_on.png"
		tiles[6] = tiles[6].."^mcl_pipeworks_lua_tube_port_on.png"
	else
		tiles[3] = tiles[3].."^mcl_pipeworks_lua_tube_port_off.png"
		tiles[4] = tiles[4].."^mcl_pipeworks_lua_tube_port_off.png"
		tiles[5] = tiles[5].."^mcl_pipeworks_lua_tube_port_off.png"
		tiles[6] = tiles[6].."^mcl_pipeworks_lua_tube_port_off.png"
	end
	if black == 1 then
		tiles[1] = tiles[1].."^(mcl_pipeworks_lua_tube_port_on.png^[transformR180)"
		tiles[2] = tiles[2].."^mcl_pipeworks_lua_tube_port_on.png"
		tiles[3] = tiles[3].."^(mcl_pipeworks_lua_tube_port_on.png^[transformR90)"
		tiles[4] = tiles[4].."^(mcl_pipeworks_lua_tube_port_on.png^[transformR270)"
	else
		tiles[1] = tiles[1].."^(mcl_pipeworks_lua_tube_port_off.png^[transformR180)"
		tiles[2] = tiles[2].."^mcl_pipeworks_lua_tube_port_off.png"
		tiles[3] = tiles[3].."^(mcl_pipeworks_lua_tube_port_off.png^[transformR90)"
		tiles[4] = tiles[4].."^(mcl_pipeworks_lua_tube_port_off.png^[transformR270)"
	end
	if white == 1 then
		tiles[1] = tiles[1].."^mcl_pipeworks_lua_tube_port_on.png"
		tiles[2] = tiles[2].."^(mcl_pipeworks_lua_tube_port_on.png^[transformR180)"
		tiles[3] = tiles[3].."^(mcl_pipeworks_lua_tube_port_on.png^[transformR270)"
		tiles[4] = tiles[4].."^(mcl_pipeworks_lua_tube_port_on.png^[transformR90)"
	else
		tiles[1] = tiles[1].."^mcl_pipeworks_lua_tube_port_off.png"
		tiles[2] = tiles[2].."^(mcl_pipeworks_lua_tube_port_off.png^[transformR180)"
		tiles[3] = tiles[3].."^(mcl_pipeworks_lua_tube_port_off.png^[transformR270)"
		tiles[4] = tiles[4].."^(mcl_pipeworks_lua_tube_port_off.png^[transformR90)"
	end
	...
	minetest.register_node("mcl_pipeworks:lua_tube" ..cid, {
		...
		after_dig_node = function(pos, node)
			...
			mcl_pipeworks.after_dig(pos, node)
		end,
