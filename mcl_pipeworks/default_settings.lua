...
mcl_pipeworks.toggles.pipe_mode = "classic"
--[[
...
for name, value in pairs(settings) do
	...
	if setting_type == "boolean" then
		mcl_pipeworks[name] = minetest.settings:get_bool(prefix..name)
		if mcl_pipeworks[name] == nil then
			mcl_pipeworks[name] = value
		end
	else
		mcl_pipeworks[name] = value
	end
