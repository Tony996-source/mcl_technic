...
local function set_tube(pos, channel, can_receive)
	...
	-- to catch regressions of https://github.com/minetest-mods/mcl_pipeworks/issues/166
	local existing = tp_tube_db[hash]
	if  existing ~= nil then
		local e = "error"
		minetest.log(e, "mcl_pipeworks teleport tube update refused due to position hash collision")
...
local function update_meta(meta, can_receive)
	...
	meta:set_string("formspec","size[8.6,2.2]"..
			...
			"label[7.3,0;Receive]"..
			"image_button[7.3,0.3;1,0.6;mcl_pipeworks_button_" .. cr_state .. ".png;cr" .. (can_receive and 0 or 1) .. ";;;false;mcl_pipeworks_button_interm.png]"..
			"image[0.3,1.3;1,1;mcl_pipeworks_teleport_tube_inv.png]"..
...
mcl_pipeworks.register_tube("mcl_pipeworks:teleport_tube", {
	description = "Teleporting Pneumatic Tube Segment",
	inventory_image = "mcl_pipeworks_teleport_tube_inv.png",
	noctr = { "mcl_pipeworks_teleport_tube_noctr.png" },
	plain = { "mcl_pipeworks_teleport_tube_plain.png" },
	ends = { "mcl_pipeworks_teleport_tube_end.png" },
	
	_mcl_blast_resistance = 0.3,
	    _mcl_hardness = 0.3,
	short = "mcl_pipeworks_teleport_tube_short.png",
	node_def = {
		...
		tube = {
			can_go = function(pos,node,velocity,stack)
				...
				pos.y = target[d].y
				pos.z = target[d].z
				return mcl_pipeworks.meseadjlist
			end
		},
		...
		on_receive_fields = function(pos,formname,fields,sender)
			...
			or not mcl_pipeworks.may_configure(pos, sender) then
				return
			end
...
minetest.register_craft( {
	output = "mcl_pipeworks:teleport_tube_1 2",
	recipe = {
	        { "mcl_pipeworks:plastic_sheet", "mcl_pipeworks:plastic_sheet", "mcl_pipeworks:plastic_sheet" },
	        { "mcl_core:redsandstone", "mesecons:redstone", "mcl_core:redsandstone" },
	        { "mcl_pipeworks:plastic_sheet", "mcl_pipeworks:plastic_sheet", "mcl_pipeworks:plastic_sheet" }
	},
})
...
if minetest.get_modpath("mesecons_mvps") ~= nil then
	mesecon.register_on_mvps_move(function(moved_nodes)
		for _, n in ipairs(moved_nodes) do
			if string.find(n.node.name, "mcl_pipeworks:teleport_tube") ~= nil then
