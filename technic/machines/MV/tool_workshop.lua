...
minetest.register_alias("tool_workshop_mv", "technic:tool_workshop_mv")
...
local run = function(pos, node)
	...
	local machine_node = "technic:tool_workshop_mv"
...
if not repairable then
		...
		technic.swap_node(pos, "technic:tool_workshop_mv")
		return
	end
	...
	elseif eu_input >= workshop_demand[EU_upgrade+1] then
	    technic.swap_node(pos, "technic:tool_workshop_mv_active")
...
minetest.register_node("technic:tool_workshop_mv", {
	description = S("%s Tool Workshop"):format("MV"),
	paramtype2 = "facedir",
	tiles = {
		"technic_mv_workshop_top.png",
		"technic_mv_workshop_bottom.png",
		"technic_mv_workshop_side.png"..tube_entry,
		"technic_mv_workshop_side.png"..tube_entry,
		"technic_mv_workshop_side.png"..tube_entry,
		"technic_mv_workshop_front.png"
	},
...
minetest.register_node("technic:tool_workshop_mv_active", {
	description = S("%s Tool Workshop"):format("MV"),
	paramtype2 = "facedir",
	tiles = {
		"technic_mv_workshop_top.png",
...
technic.register_machine("MV", "technic:tool_workshop_mv", technic.receiver)
