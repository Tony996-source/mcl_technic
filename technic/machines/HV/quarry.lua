...
local function set_quarry_formspec(meta)
	...
	local formspec = "size[6,4.3]"..
		...
		"item_image[4.8,0;1,1;technic:hv_quarry]"..
...
minetest.register_node("technic:hv_quarry", {
	description = S("%s Quarry"):format("HV"),
	tiles = {
		"technic_hv_quarry_bottom.png"..tube_entry,
		"technic_hv_quarry_bottom.png"..cable_entry,
		"technic_hv_quarry_bottom.png"..cable_entry,
		"technic_hv_quarry_bottom.png"..cable_entry,
		"technic_hv_quarry_front.png",
		"technic_hv_quarry_bottom.png"..cable_entry
	},
	paramtype2 = "facedir",
...
technic.register_machine("HV", "technic:hv_quarry", technic.receiver)
