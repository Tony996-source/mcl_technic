...
minetest.register_craft({
	...
	recipe = {
		{'mcl_core:iron_ingot', 'technic:rubber','mcl_core:iron_ingot'},
		{'technic:carbon_plate', '', 'technic:carbon_plate'},
		{'mcl_core:iron_ingot', 'technic:carbon_plate', 'mcl_core:iron_ingot'},
	}
})
