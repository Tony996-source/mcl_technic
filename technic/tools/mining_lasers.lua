...
minetest.register_craft({
	...
	recipe = {
	{"mcl_core:diamond", "mcl_core:iron_ingot", "mcl_core:glass_black"},
	{"", "mcl_core:gold_ingot", "group:button"},
	{"", "", "technic:battery"},
	}
})
minetest.register_craft({
	...
	recipe = {
	{"mcl_core:diamond", "mcl_core:iron_ingot", "technic:laser_mk1"},
	{"", "mcl_core:gold_ingot", "group:button"},
	{"", "", "technic:battery"},
	}
})
minetest.register_craft({
	...
	recipe = {
	{"mcl_core:diamond", "mcl_core:iron_ingot", "technic:laser_mk2"},
	{"", "mcl_core:gold_ingot", "group:button"},
	{"", "", "technic:battery"},
	}
})
