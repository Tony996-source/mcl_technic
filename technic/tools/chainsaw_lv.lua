...
technic.register_power_tool("technic:chainsaw_lv", chainsaw_max_charge)
...
minetest.register_tool("technic:chainsaw_lv", {
	description = S("LV Chainsaw"),
	inventory_image = "technic_chainsaw_lv.png",
	stack_max = 1,
...
minetest.register_craft({
	output = "technic:chainsaw_lv",
	recipe = {
	{"mcl_core:iron_ingot", "group:button", "technic:battery"},
	{"mcl_core:iron_ingot", "mcl_core:iron_ingot",  "technic:lv_cable"},
	{"",                "",         "mcl_core:iron_ingot"},
	},
