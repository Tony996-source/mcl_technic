...
technic.register_power_tool("technic:vacuum_lv", vacuum_max_charge)

minetest.register_tool("technic:vacuum_lv", {
	description = S("LV Vacuum Cleaner"),
	inventory_image = "technic_vacuum_lv.png",
	stack_max = 1,
...
minetest.register_craft({
	output = 'technic:vacuum_lv',
	recipe = {
	{'technic:rubber', 'technic:carbon_plate', 'group:button'},
	{'technic:rubber', 'mcl_core:iron_ingot', 'technic:battery'},
