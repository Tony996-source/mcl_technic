...
technic.register_power_tool("technic:chainsaw_hv", chainsaw_max_charge)
...
minetest.register_tool("technic:chainsaw_hv", {
	description = S("HV Chainsaw"),
	inventory_image = "technic_chainsaw_hv.png",
	stack_max = 1,
...
minetest.register_craft({
	output = "technic:chainsaw_hv",
	recipe = {
	{"mcl_core:iron_ingot", "group:button", "technic:battery"},
	{"mcl_core:iron_ingot", "mcl_core:gold_ingot", "technic:hv_cable"},
	{"",                    "",          "mcl_core:iron_ingot"},
	},
