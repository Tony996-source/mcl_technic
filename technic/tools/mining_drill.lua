...
minetest.register_craft({
	...
	recipe = {
    {'mcl_core:iron_ingot', 'technic:diamond_drill_head', 'mcl_core:iron_ingot'},
    {'mcl_core:iron_ingot', 'mcl_core:gold_ingot', 'mcl_core:iron_ingot'},
	{'',  'group:button', 'mcl_core:gold_ingot'},
	}
})
minetest.register_craft({
	...
	{'mcl_core:iron_ingot', 'technic:mining_drill', 'mcl_core:iron_ingot'},
	{'',                              'group:button', ''},
	}
})
minetest.register_craft({
	...
	recipe = {
	{'technic:diamond_drill_head',    'technic:diamond_drill_head',  'technic:diamond_drill_head'},
	{'mcl_core:iron_ingot', 'technic:mining_drill_mk2', 'mcl_core:iron_ingot'},
	{'',                              'group:button', ''},
	}
})
for i = 1, 4 do
	minetest.register_craft({
		...
		recipe = {
		{'technic:diamond_drill_head',    'technic:diamond_drill_head',   'technic:diamond_drill_head'},
		{'mcl_core:iron_ingot', 'technic:mining_drill_mk2_'..i, 'mcl_core:iron_ingot'},
		{'',                              'group:button',  ''},
		}
	})
end
