...
technic.register_power_tool("technic:vacuum_mv", vacuum_max_charge)

minetest.register_tool("technic:vacuum_mv", {
	description = S("MV Vacuum Cleaner"),
	inventory_image = "technic_vacuum_mv.png",
	stack_max = 1,
...
minetest.register_craft({
	...
	{'technic:rubber', 'mcl_copper:copper_ingot', 'technic:battery'},
