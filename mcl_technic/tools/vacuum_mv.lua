-- Configuration
local vacuum_max_charge        = 100000 -- 100000 - Maximum charge of the vacuum cleaner
...
mcl_technic.register_power_tool("mcl_technic:vacuum_mv", vacuum_max_charge)

minetest.register_tool("mcl_technic:vacuum_mv", {
	description = S("MV Vacuum Cleaner"),
	inventory_image = "mcl_technic_vacuum_mv.png",
	stack_max = 1,
...
minetest.register_craft({
	output = 'mcl_technic:vacuum_mv',
	recipe = {
	{'mcl_technic:vacuum_lv',       'mcl_technic:carbon_plate', 'mcl_technic:carbon_plate'},
	{'mcl_technic:rubber',          'mcl_copper:copper_ingot',  'mcl_technic:battery'},
