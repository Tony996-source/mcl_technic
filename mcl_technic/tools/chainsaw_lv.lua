...
local chainsaw_max_charge      = 15000 -- Maximum charge of the saw
...
mcl_technic.register_power_tool("mcl_technic:chainsaw_lv", chainsaw_max_charge)
...
minetest.register_tool("mcl_technic:chainsaw_lv", {
	description = S("LV Chainsaw"),
	inventory_image = "mcl_technic_chainsaw_lv.png",
	stack_max = 1,
...
minetest.register_craft({
	output = "mcl_technic:chainsaw_lv",
	recipe = {
	{"mcl_core:iron_ingot", "group:button", "mcl_technic:battery"},
	{"mcl_core:iron_ingot", "mcl_core:iron_ingot",  "mcl_technic:lv_cable"},
	{"",                "",         "mcl_core:iron_ingot"},
	},
