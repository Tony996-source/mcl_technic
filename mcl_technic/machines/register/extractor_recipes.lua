...
if minetest.get_modpath("mcl_rubber") then	
	...
	{"mcl_mobitems:ink_sac",          "mcl_dye:black 4"},
	{"mcl_cocoas:cocoa_beans",        "mcl_dye:brown 4"},
	{"mcl_bone_meal:bone_meal",       "mcl_dye:white 4"},
	{"mcl_flowers:azure_bluet",       "mcl_dye:grey 4"},
	...
	{"mcl_core:stonebrickmossy 8",    "mcl_core:moss"},
	{"mcl_core:mossycobble 8",        "mcl_core:moss"},
