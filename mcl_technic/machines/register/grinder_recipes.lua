...
-- Trees
    {"mcl_core:tree",                   "mcl_technic:sawdust 4"},
    {"mcl_core:jungletree",             "mcl_technic:sawdust 4"},
    {"mcl_core:birchtree",              "mcl_technic:sawdust 4"},
    {"mcl_core:sprucetree",             "mcl_technic:sawdust 4"},
    {"mcl_core:acaciatree",             "mcl_technic:sawdust 4"},
    {"mcl_core:darktree",               "mcl_technic:sawdust 4"},
    ...
    {"mcl_core:stripped_acacia",        "mcl_technic:sawdust 2"},
    {"mcl_core:stripped_birch",         "mcl_technic:sawdust 2"},
    {"mcl_core:stripped_dark_oak",      "mcl_technic:sawdust 2"},
    {"mcl_core:stripped_jungle",        "mcl_technic:sawdust 2"},
    {"mcl_core:stripped_oak",           "mcl_technic:sawdust 2"},
    {"mcl_core:stripped_spruce",        "mcl_technic:sawdust 2"},
    {"mcl_core:stripped_acacia_bark",   "mcl_technic:sawdust 2"},
    {"mcl_core:stripped_birch_bark",    "mcl_technic:sawdust 2"},
    {"mcl_core:stripped_dark_oak_bark", "mcl_technic:sawdust 2"},
    {"mcl_core:stripped_jungle_bark",   "mcl_technic:sawdust 2"},
    {"mcl_core:stripped_oak_bark",      "mcl_technic:sawdust 2"},
    {"mcl_core:stripped_spruce_bark",   "mcl_technic:sawdust 2"},
    {"mcl_core:acacia_bark",            "mcl_technic:sawdust 2"},
    {"mcl_core:birch_bark",             "mcl_technic:sawdust 2"},
    {"mcl_core:dark_oak_bark",          "mcl_technic:sawdust 2"},
    {"mcl_core:jungle_bark",            "mcl_technic:sawdust 2"},
    {"mcl_core:oak_bark",               "mcl_technic:sawdust 2"},
    {"mcl_core:spruce_bark",            "mcl_technic:sawdust 2"},
