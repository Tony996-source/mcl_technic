...
minetest.register_alias("tool_workshop", "mcl_technic:tool_workshop_hv")
...
local run = function(pos, node)
	...
	local machine_node = "mcl_technic:tool_workshop_hv"
	...
	if not repairable then
		...
		mcl_technic.swap_node(pos, "mcl_technic:tool_workshop_hv")
		return
	end
	...
	elseif eu_input >= workshop_demand[EU_upgrade+1] then
	    mcl_technic.swap_node(pos, "mcl_technic:tool_workshop_hv_active")
...
minetest.register_node("mcl_technic:tool_workshop_hv", {
	description = S("%s Tool Workshop"):format("HV"),
	paramtype2 = "facedir",
	tiles = {
		"mcl_technic_hv_workshop_top.png",
		"mcl_technic_hv_workshop_bottom.png",
		"mcl_technic_hv_workshop_side.png"..tube_entry,
		"mcl_technic_hv_workshop_side.png"..tube_entry,
		"mcl_technic_hv_workshop_side.png"..tube_entry,
		"mcl_technic_hv_workshop_front.png"
	},
	groups = {pickaxey=1,axey=1, handy=1, swordy=1,
		mcl_technic_machine=1, mcl_technic_hv=1, tubedevice=1, tubedevice_receiver=1},
...
minetest.register_node("mcl_technic:tool_workshop_hv_active", {
	description = S("%s Tool Workshop"):format("HV"),
	paramtype2 = "facedir",
	tiles = {
		"mcl_technic_hv_workshop_top.png",
		...
		"mcl_technic_hv_workshop_side.png"..tube_entry,
		"mcl_technic_hv_workshop_side.png"..tube_entry,
		"mcl_technic_hv_workshop_front_active.png"
	},
	groups = {pickaxey=1,axey=1, handy=1, swordy=1, not_in_creative_inventory = 1,
		mcl_technic_machine=1, mcl_technic_hv=1, tubedevice=1, tubedevice_receiver=1},
	drop = "mcl_technic:tool_workshop_hv",
	connect_sides = {"bottom", "back", "left", "right"},
	sounds = mcl_sounds.node_sound_wood_defaults(),
	on_construct = function(pos)
		local meta = minetest.get_meta(pos)
...
mcl_technic.register_machine("HV", "mcl_technic:tool_workshop_hv", mcl_technic.receiver)
