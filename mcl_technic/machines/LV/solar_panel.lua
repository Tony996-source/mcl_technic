...
minetest.register_craft({
	output = 'mcl_technic:solar_panel',
	recipe = {
...
minetest.register_node("mcl_technic:solar_panel", {
	tiles = {"mcl_technic_solar_panel_top.png",  "mcl_technic_solar_panel_bottom.png", "mcl_technic_solar_panel_side.png",
	         "mcl_technic_solar_panel_side.png", "mcl_technic_solar_panel_side.png",   "mcl_technic_solar_panel_side.png"},
	groups = {snappy=2, choppy=2, oddly_breakable_by_hand=2,
		mcl_technic_machine=1, mcl_technic_lv=1},
...
mcl_technic.register_machine("LV", "mcl_technic:solar_panel", mcl_technic.producer)
