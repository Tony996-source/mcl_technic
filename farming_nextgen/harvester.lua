-- The harvester
    ...
    -- farming
	farmingNG.harvester_names["mcl_farming:wheat"] = true 
	farmingNG.harvester_names["mcl_farming:carrot"]	= true
	farmingNG.harvester_names["mcl_farming:melon"]	= true
	farmingNG.harvester_names["mcl_farming:potato"]	= true
	farmingNG.harvester_names["mcl_farming:pumpkin_7"]	= true
	farmingNG.harvester_names["mcl_farming:beetroot"]	= true
...
if farmingNG.havetech then	
	  ...
	  minetest.register_craft({
		  ...
		  recipe = {
			  ...
			  {"technic:diamond_drill_head", "mcl_core:gold_ingot", "technic:diamond_drill_head"},
