...
local function punch_filter(data, filtpos, filtnode, msg)
	...
	local input_special_cases = {
		...
		["technic:tool_workshop_mv"] = "src",
		["technic:mv_freezer"] = "dst",
		["technic:mv_freezer_active"] = "dst",
		["technic:mv_battery_box"] = "dst",
		
		["technic:hv_furnace"] = "dst",
		["technic:hv_furnace_active"] = "dst",
		["technic:hv_electric_furnace"] = "dst",
		["technic:hv_electric_furnace_active"] = "dst",
		["technic:hv_alloy_furnace"] = "dst",
		["technic:hv_alloy_furnace_active"] = "dst",
		["technic:hv_compressor"] = "dst",
		["technic:hv_compressor_active"] = "dst",
		["technic:hv_extractor"] = "dst",
		["technic:hv_extractor_active"] = "dst",
		["technic:hv_grinder"] = "dst",
		["technic:hv_grinder_active"] = "dst",
		["technic:tool_workshop_hv"] = "src",
		["technic:hv_freezer"] = "dst",
		["technic:hv_freezer_active"] = "dst",
		["technic:hv_battery_box"] = "dst"
	}
