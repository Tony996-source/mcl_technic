...
if pipeworks.enable_conductor_tube then
	...
	minetest.register_craft({
		...
		recipe = {"pipeworks:tube_1", "mesecons:redstone"}
	})
end
...
if digiline_enabled and pipeworks.enable_digiline_conductor_tube and
	...
	minetest.register_craft({
		...
		recipe = {"pipeworks:tube_1", "mesecons:redstone", "digilines:wire_std_00000000"}
	})
	minetest.register_craft({
		type = "shapeless",
		output = "pipeworks:mesecon_and_digiline_conductor_tube_off_1",
	...
	minetest.register_craft({
		type = "shapeless",
		output = "pipeworks:mesecon_and_digiline_conductor_tube_off_1",
		recipe = {"pipeworks:digiline_conductor_tube_1", "mesecons:redstone"}
	})
end
